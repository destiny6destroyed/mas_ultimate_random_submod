...
1. What this submod do?
    ...
    - Custom Random mode: If you enable True Random, you can choose what elements stay and what elements are changed when you start MAS (including Locations, but excluding Clothes and Hairs)


2. To make this submod work, you need:
    - Hair and Clothes Selector Unlocked
...
4. You can edit the hair's ex_props inside the json files to make the hairstyles match with the ribbons you need to set up the random as you wish
